				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="boutiqued@inbox.ru">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost:8080/ecommerce/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost:8080/ecommerce/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost:8080/ecommerce/cancel.php"/>
